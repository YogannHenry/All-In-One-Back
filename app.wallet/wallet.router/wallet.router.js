...
router.post('/api/wallet/:walletId/document', upload.single('uploaded_file'), schemaValidator(documentSchema.modifyDocumentSchema), wrapperController(documentController.createOneDocument));
